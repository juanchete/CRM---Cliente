...
function nuevocliente() {
    ...
    const [mensaje, guardadMensaje] = useState(null);
    ...
    const [nuevoCliente] = useMutation(NUEVO_CLIENTE,{
        update(cache, {data: { nuevoCliente }}) {
            ...
            //REescribimos el cache {cache no se modifica se rescribe}
            cache.writeQuery({
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            apellido: Yup.string()
                    .required('El nombre del apellido es obligatorio'),
            empresa: Yup.string()
        ...
        onSubmit: async valores => {
            ...
            try {
                ...
                guardadMensaje(error.message.replace('GraphQL error: ',''));
